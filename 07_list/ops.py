...
print(num_list)
num_list.remove(10) # only first occurrence 
print(num_list)
...
# reverse() : reverses the list, performs inplace operation
num_list = [10,20,30,40,50] 
print(num_list)
...
# sort() : sorts the list, inplace operation, default is ascending order  
