...
with open("14_file_operation/students.csv","r") as file_data:
...
with open("14_file_operation/employees.csv","w") as file_data:
...
with open("14_file_operation/employees.csv","a") as file_data:
    csv_writer = csv.writer(file_data)
    csv_writer.writerow(['name', 'email', 'mobile', 'address'])
    csv_writer.writerow(['ravi', 'ravi@gmail.com', '998998998', 'hyderabad'])
    csv_writer.writerows([['ramu', 'ramu@outlook.com', '998998998', 'bangalore'],
...
with open("14_file_operation/students.csv","w") as file_data:
