...
with open("14_file_operation/student.json","w") as file_data:
...
# Writing To JSON File Without Recommended Indentation is 4
with open("14_file_operation/student.json","w") as file_data:
    json.dump(student,file_data,indent=4)
    
# Reading JSOn File 
with open("14_file_operation/student.json","r") as file_data:
...
with open("14_file_operation/users.json","r") as file_data:
